...
(function (doc) {
  var message = 'This site or app is sending too much traffic to staticdelivr.up.railway.app. Please contact its owner and ask them to use cdn.rawgit.com instead, which has no traffic limit.';
