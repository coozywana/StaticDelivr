...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">93.89% <small>(338 / 360)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">85.04% <small>(199 / 234)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">89.83% <small>(53 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.85% <small>(336 / 358)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
830
831
832</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (key === 'host' &amp;&amp;
          (<span class="branch-1 cbranch-no" title="branch not covered" >_.isUndefined(header) </span>||
<span class="branch-2 cbranch-no" title="branch not covered" >           _.isUndefined(reqHeader))</span>)
        {
...
&nbsp;
      for (var q in queries) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isUndefined(this.queries[q])) {
          var value = queries[q];
&nbsp;
          switch (true) {
          ...
          case _.isBoolean(value):
            ...
            break;
<span class="branch-2 cbranch-no" title="branch not covered" >          case _.isUndefined(value): </span>// fall-though
          case _.isNull(value):
            value = '';
            break;
