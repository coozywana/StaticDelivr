...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">92.02% <small>(219 / 238)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">89.17% <small>(140 / 157)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">92.86% <small>(26 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">92.41% <small>(219 / 237)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-yes">3615</span>
<span class="cline-any cline-yes">3426</span>
...
&nbsp;
  var response;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (IncomingMessage) {
    response = new IncomingMessage(new EventEmitter());
  } else {
<span class="cstat-no" title="statement not covered" >    response = new ReadableStream();</span>
<span class="cstat-no" title="statement not covered" >    response._read = <span class="fstat-no" title="function not covered" >function() {</span>};</span>
  }
&nbsp;
